package com.campussocialmedia.mediaservice.service;
...
public class MediaService {
    ...
    private void initializeAmazon() {
        BasicSessionCredentials sessionCredentials = new BasicSessionCredentials(this.accessKey, this.secretKey,
                this.sessionToken);
